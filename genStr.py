...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@ProgramStringSessionBot](tg://openmessage?user_id=5046276919) \nA Bot By @Souravkkk")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/magicpinflipkartloots'),
                InlineKeyboardButton('Developer', url='https://t.me/Souravkkk')
            ]
        ]
    )
